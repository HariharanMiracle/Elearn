<main class="container" style="padding: 20px;">
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <a href="<?php echo base_url('/News/create'); ?>" class="btn-link" alt="Create News">Add New</a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3><i class="fas fa-list-alt"></i> All News</h3>
                    <br />
                    <?php
                        if ($news) {
                            ?>
                                <div class="row">
                                    <form class="form-inline ml-4 mb-2" action="<?php echo base_url('/News/search'); ?>" method="post">
                                ...
                                <br/>
                            <?php
                            echo '<table class="table table-striped table-bordered" id="news">';
                                echo '<thead>';
                                    echo '<tr>';
                                        echo '<th>No</th>';
                                        echo '<th>Title</th>';
                                ...
                                echo '<tbody>';
                                    ...
                                    foreach ($news as $obj) {
                                        ...
                                        echo '<tr>';
                                            ...
                                            echo '<td><a class="a-orange" href="'.base_url().'/News/edit/'.$obj['id'].'" alt="Edit Category - '.$obj['title'].'"><i class="far fa-edit"></i></a></td>';
                                            echo '<td><a class="a-orange" href="'.base_url().'/News/delete/'.$obj['id'].'" alt="Delete Category - '.$obj['title'].'"><i class="far fa-trash-alt"></i></a></td>';
                                        echo '</tr>';
                                        $count++;
                                    }
                                echo '</tbody>';
