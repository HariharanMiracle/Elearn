<div style="padding: 25px;" class="bgstyle">
    <div class="row" style="padding: 25px;">
        ...
        <div class="col-12" style="margin-top: 30px;">
            <form action="<?php echo base_url('/Home/articlesSearch'); ?>" method="post">
                <div class="container">
                    <div class="row">
    ...
    <br/>
    <div class="bgstyle">
        <div class="wm-fancy-title"> <h2>Our <span>Articles</span></h2> </div>
        <div class="wm-courses wm-courses-popular">
            <ul class="row">
                <?php
                    $count = 1;
                    foreach ($articles as $articlesObj) {
                        if($count % 2 == 0){
                            ?>
                                <li class="col-md-3" style="margin-top: 10px;">
                                    <div class="wm-courses-popular-wrap">
                                        <figure> <a href="<?php echo base_url().'/uploads/pdf/articles/'.$articlesObj['pdf']; ?>" download><img src="<?php echo base_url().'/design/extra-images/papular-courses-3.jpg'; ?>" alt=""> <span class="wm-popular-hover"> <small>Download</small> </span> </a>
                                            <figcaption>
                                            <img src = "<?php echo base_url().'/uploads/images/2.png'; ?>" height="60px" width="60px"/>
                                                <h6><?php echo $articlesObj['title']; ?></h6>
                                            </figcaption>
                                        </figure>
                                        <div class="wm-popular-courses-text">
                                            <a href="<?php echo 'http://flowpaper.com/flipbook/'.base_url().'/uploads/pdf/articles/'.$articlesObj['pdf']; ?>" class="btn btn-success" target="_blank">Read Me!</a>
                                        </div>
                                    </div>
                                </li>
                            <?php
                            ...
                            ?>
                                <li class="col-md-3" style="margin-top: 10px;">
                                    <div class="wm-courses-popular-wrap">
                                        <figure> <a href="<?php echo base_url().'/uploads/pdf/articles/'.$articlesObj['pdf']; ?>" download><img src="<?php echo base_url().'/design/extra-images/papular-courses-4.jpg'; ?>" alt=""> <span class="wm-popular-hover"> <small>Download</small> </span> </a>
                                            <figcaption>
